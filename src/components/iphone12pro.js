...
import './page1.css';
class iphone12pro extends React.Component{
  constructor(props) {
    super(props);
    this.state = {price: "125,900"};
  }
  componentDidMount() {
    setTimeout(() => {
      this.setState({price: "124,999"})
    }, 3000)
  }
  ...
  componentDidUpdate() {
    ...
    <div>
      <br/>
    <img id="i1" src="iphone12pro(1).png" />
    ...
    0.3 MP, TOF 3D, f/1.0, (depth)</td></tr>
             ...
             <tr><td>Price</td>	<td>₹ 125,900 / $ 1,059.97 / £ 999.00 / € 1,150.25 </td></tr>
    ...
    <br/>
    <div id="d5">
    <iframe id="frame" src="https://www.youtube.com/embed/qrzCLgDplTw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
