...
import './page1.css';
class One9 extends React.Component{
  constructor(props) {
    super(props);
    this.state = {price: "49,999"};
  }
  componentDidMount() {
    setTimeout(() => {
      this.setState({price: "48,999"})
    }, 3000)
  }
    ...
    render(){
        return(
            ...
            <tr><td>Internal</td>	<td>128GB 8GB RAM, 256GB 8GB RAM, 256GB 12GB RAM UFS 3.1</td>
                     ...
                     <tr><td>Price</td>	<td>₹ 49,999 / $ 643.99 / £ 611.59 / € 690.00</td></tr>
            ...
            <br/>
            <div id="d5">
            <iframe id="frame" src="https://www.youtube.com/embed/RY63Nw0w33w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
            <br/>
            <br/>
