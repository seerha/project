...
import './page1.css';
class iphone11pro extends React.Component{
  constructor(props) {
    super(props);
    this.state = {price: "54,900"};
  }
  componentDidMount() {
    setTimeout(() => {
      this.setState({price: "54,000"})
    }, 3000)
  }
  ...
  componentDidUpdate() {
    ...
    <div>
      <br/>
    <img id="i1" src="iphone11.png" />
    <div id="d2" class="card bg-light text-dark">
    <p id="p2">Released 2019, September 20
</p>
    </div>
    <br/>
    ...
    0.3 MP, TOF 3D, f/1.0, (depth)</td></tr>
             ...
             <tr><td>Price</td>	<td>₹ 54,900 / $ 549.95 / £ 419.70 / € 561.34</td></tr>
    ...
    <br/>
    <div id="d5">
    <iframe id="frame" src="https://www.youtube.com/embed/OoY7zp8GkLI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <br/>
    <br/>
    
<h3 id="buy">Wanna Buy This Phone. Try Here !</h3> 
<br/>
<br></br><br></br>
    </div>
        )
