...
class iphone11pro extends React.Component{
  constructor(props) {
    super(props);
    this.state = {price: "78,900"};
  }
  componentDidMount() {
    setTimeout(() => {
      this.setState({price: "77,000"})
    }, 3000)
  }
  ...
  componentDidUpdate() {
    ...
    <img id="i1" src="iphone11pro.png" />
    <div id="d2" class="card bg-light text-dark">
    <p id="p2">2019 , September 20
</p>
    </div>
    <br/>
    ...
    <br/>
    <div id="d5">
    <iframe id="frame" src="https://www.youtube.com/embed/nxf41fMX_Y4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
     </div>
    <br/>
    <br/>
    </div>
