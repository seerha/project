...
import './page1.css';
class One8 extends React.Component{
  constructor(props) {
    super(props);
    this.state = {price: "41,999"};
  }
  componentDidMount() {
    setTimeout(() => {
      this.setState({price: "40,999"})
    }, 3000)
  }
...
1440x3168 pixels</p>
            ...
            <br/>
            <div id="d5">
            <iframe id="frame" src="https://www.youtube.com/embed/OHP1rLwR6r8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </div>
            <br/>
            <br/>
