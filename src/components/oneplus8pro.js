...
import './page1.css';
class One8pro extends React.Component{
  constructor(props) {
    super(props);
    this.state = {price: "54,999"};
  }
  componentDidMount() {
    setTimeout(() => {
      this.setState({price: "53,999"})
    }, 3000)
  }
  ...
  componentDidUpdate() {
    ...
    render(){
        return(
            ...
            <div>
              <br/>
            <img id="i1" src="oneplus8pro.png"/>
            <div id="d2" class="card bg-light text-dark">
            <p id="p2">Released 2020, April 21</p>
            </div>
            <br/>
            
            <div class="card bg-light text-dark" id="d3">
            <p id="p2">199g, 8.5mm thickness</p>
            </div>
            <br/>
            
            
            <div class="card bg-light text-dark" id="d2">
              <p id="p2">Android 10, OxygenOS 11 </p>
              </div>
              <br/>
...
1440x3168 pixels</p>
                ...
                <div class="card bg-light text-dark" id="d3">
                <p id="p2">48 MP, 2160p Main Camera. </p>
                </div>
                <br/>
                
                
                <div class="card bg-light text-dark" id="d2">
                  <p id="p2">8/12 Gb RAM, Snapdragon 865 5g.</p>
                  </div>
                  <br/>
                  
                <div class="card bg-light text-dark" id="d3">
                  <p id="p2">4510mAh of Li-Po Battery.</p>
                  </div>
                  <br/>
            </div>
            ...
            <tr><td>Internal</td>	<td>128GB 8GB RAM, 256GB 8GB RAM, 256GB 12GB RAM UFS 3.1</td>
                     ...
                     <tr><td>Price</td>	<td>	$ 629.00 / £ 591.97 / € 617.16</td></tr>
            ...
            <br/>
            <div id="d5">
            <iframe id="frame" src="https://www.youtube.com/embed/LTDuGU38-70" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <br/>
            <br/>
